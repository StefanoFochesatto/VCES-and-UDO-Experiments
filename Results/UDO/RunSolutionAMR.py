...
def NodeMark(msh, u, lb, iter):
    ...
    nNeighbors = mark_neighbors(msh, OuterElements, W, 3, ActiveSet)
...
def RunSolutionAMRRefactor(max_iterations):
    l2 = []
    IoU = []
    Hausdorff = []
...
if __name__ == "__main__":
    ...
    (l2, IoU, Hausdorff, meshHierarchy) = RunSolutionAMRRefactor(max_iterations)

    RefinementsAMR = list(range(len(meshHierarchy) - 1))
    Elements = []
    dof = []
