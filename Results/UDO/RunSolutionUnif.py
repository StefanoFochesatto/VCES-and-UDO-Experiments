...
def RunSolutionUnifRefactor(max_iterations):
    l2 = []
    IoU = []
    Hausdorff = []
...
if __name__ == "__main__":
    ...
    (l2, IoU, Hausdorff, meshHierarchy) = RunSolutionUnifRefactor(max_iterations)
